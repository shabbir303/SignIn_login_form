  ...
  const emailRef = useRef('');
    ...
    const handleForgetPassword = e =>{
      ...
      if(!email){
        ...
        console.log('plese provide a valid email');
        return;
      }
      sendPasswordResetEmail(auth, email)
      .then(()=>{
    ...
    // const signUp = ()=>{
    //   location.replace('http://localhost:5173/register');
    // }
    ...
    <a onClick={handleForgetPassword}
        className="font-medium text-[#DC0B0B] transition-colors hover:text-blue-700"
        href="#" 
      >
        Forget Password?
        {/* mange Users theke korte hobe */}
      </a>
...
Register
  ...
  {
   loginError? <p className="btn btn-outline btn-warning"> Invalid-login-credentials </p>: ""
  }
  {
    loginSuccess? <p className="btn btn-outline btn-success"> Successfully Login </p>:""
  }
            </div>
        </div>
    );
